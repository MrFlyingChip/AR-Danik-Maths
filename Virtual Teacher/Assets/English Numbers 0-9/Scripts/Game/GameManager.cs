...
public class GameManager : MonoBehaviour
{
		...
		private void CreateShape ()
		{
				...
				try {
						shapeOrder.text = TableShape.selectedShape.ID + "/" + ShapesManager.instance.shapes.Count;
						ShapesTable.lastSelectedGroup = TableShape.selectedShape.ID - 1;
						GameObject shapePrefab = ShapesManager.instance.shapes [TableShape.selectedShape.ID - 1].gamePrefab;
