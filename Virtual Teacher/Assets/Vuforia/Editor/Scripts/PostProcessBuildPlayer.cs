...
namespace Vuforia.EditorClasses
{
    ...
    class PostProcessBuildPlayer
    {
        ...
        private static void ProcessPbxProj(string xCodeProjFileName, Framework[] frameworks, ResFile[] resFiles)
        {
            ...
            var pbxprojFilename = System.IO.Path.Combine(xCodeProjFileName, "project.pbxproj");
            ...
            foreach (var rf in resFiles)
                if (Directory.Exists(System.IO.Path.Combine(xCodeProjFileName, "../Data/Raw/" + rf.Name)))
                {
                    newResFiles.Add(rf);
                }
        ...
        public static void OnPostprocessBuild(BuildTarget target, string pathToBuiltProject)
        {
            ...
            {
                var xCodeProjFullPath = System.IO.Path.Combine(pathToBuiltProject, "Unity-iPhone.xcodeproj");
