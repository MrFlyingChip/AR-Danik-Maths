...
namespace Fabric.Internal.Editor.ThirdParty.xcodeapi
{
    ...
    internal class AssetCatalog
    {
        ...
        {
            if (System.IO.Path.GetExtension(path) != ".xcassets")
        ...
        public AssetDataSet OpenDataSet(string relativePath)
        {
            ...
            return folder.OpenDataSet(System.IO.Path.GetFileName(relativePath));
        }

        public AssetImageSet OpenImageSet(string relativePath)
        {
            var folder = OpenFolderForResource(relativePath);
            return folder.OpenImageSet(System.IO.Path.GetFileName(relativePath));
        }
        
        public AssetImageStack OpenImageStack(string relativePath)
        {
            var folder = OpenFolderForResource(relativePath);
            return folder.OpenImageStack(System.IO.Path.GetFileName(relativePath));
        }
    ...
    internal class AssetFolder : AssetCatalogItem
    {
        ...
        {
            if (name != null)
                m_Path = System.IO.Path.Combine(parentPath, name);
            else
                m_Path = parentPath;
        }
    ...
    internal class AssetDataSet : AssetCatalogItemWithVariants
    {
        ...
        {
            m_Path = System.IO.Path.Combine(parentPath, name + ".dataset");
        }
    ...
    internal class AssetImageSet : AssetCatalogItemWithVariants
    {
        ...
        {
            m_Path = System.IO.Path.Combine(assetCatalogPath, name + ".imageset");
        }
    ...
    */
    class AssetImageStackLayer : AssetCatalogItem
    {
        ...
        {
            m_Path = System.IO.Path.Combine(assetCatalogPath, name + ".imagestacklayer");
    ...
    class AssetImageStack : AssetCatalogItem
    {
        ...
        {
            m_Path = System.IO.Path.Combine(assetCatalogPath, name + ".imagestack");
        }
